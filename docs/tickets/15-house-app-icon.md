...
Use the app's existing green palette with a high-contrast light house outline. Keep the design free of text, brick textures, landscaping, cars, neighboring buildings, and photographic detail. The reference photo remains local; do not upload or commit it. The owner selected the revised green-and-ivory concept with the front door on 2026-09-25. During implementation, the owner requested moving the lower bay left so a wider door has its own space at the bottom-right; that adjustment is included in the final vector master.
